...
import com.mojio.xls.read.Xls_Reader;
import com.mojio.test.Constants;
...
public static String result_FolderName=null;
	public static void main(String[] arg) throws Exception {
		...
		FileInputStream fs = new FileInputStream(System.getProperty("user.dir")+"//src//com//mojio//config//config.properties");
		Properties CONFIG= new Properties();
		CONFIG.load(fs);
		String environment=CONFIG.getProperty("environment");
		String release=CONFIG.getProperty("release");
		Xls_Reader suiteXLS = new Xls_Reader(System.getProperty("user.dir")+"//src//com//mojio//xls//Suite.xlsx");
		...
		try{
			 ...
			 out.write("<html><HEAD> <TITLE>Mojio Dev Centre Automation Test Results</TITLE></HEAD><body><h4 align=center><FONT COLOR=660066 FACE=AriaL SIZE=6><b><u> Mojio Platform Automation Test Results</u></b></h4><table  border=1 cellspacing=1 cellpadding=1 ><tr><h4> <FONT COLOR=660000 FACE=Arial SIZE=4.5> <u>Test Details :</u></h4><td width=150 align=left bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Run Date</b></td><td width=150 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>");
			...
			// out.write("<tr><td width=20% align= center><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>TC04</b></td><td width=40% align= center><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>TC04</b></td><td width=10% align=center  bgcolor=yellow><FONT COLOR=153E7E FACE=Arial SIZE=2><b>Skip</b></td></tr>");
			 ...
			 for(int currentSuiteID =2;currentSuiteID<= totalTestSuites;currentSuiteID++){
				 ...
				 current_suite_xls=new Xls_Reader(System.getProperty("user.dir")+"//src//com//mojio//xls//"+currentTestSuite+".xlsx");
